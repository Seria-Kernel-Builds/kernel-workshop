...
class VirtualKernel:
    ...
    def load_modules(self, modules_load_file: str, real_modules_path: str = "") -> bool:
        ...
        def _load_module(module_path_: str) -> bool:
            if module_path_ in failed_modules:
                return False
            ...
            if self.load_module(kernel_module_):
                ...
                failed_modules.add(module_path_)
                remain_modules.discard(module_path_)
                return False
        ...
        for module in modules_iter:
            if not _load_module(module):
                ...
                is_success = False
        if not is_success:
            print("\nError: The following kernel modules failed to load (or their dependencies failed):")
